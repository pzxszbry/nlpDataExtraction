...
# >>>>>>> 49c3523ad6e75a8c7732005cfdbd5165806d6ad5
        ...
        print_list.clear()
        for pt in parseTree:
            print_list.append(str(pt))
        self.parseFile.write('\n'.join(print_list))
